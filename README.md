...
local nameofthescript = "Elemental" --put your script name here. leave blank too leave blank ig
...
TargetingGroup:AddToggle("AimLock", {
    Text = "AimLock",
    Default = false,
...
getgenv().hitsoundEnabled = Enable
...
local killSayMessages = {
    "Elemental is a free script and u die to it..", 
    "Must be hard without Elemental💔", 
    "Why aim when Elemental does it for you?",
    "Bros not on Elemental already 😂",
    "Cant be me icl",
    "cant win a hvh? maybe try /Elementalhvh",
    "if u wanna win hop in /Elementalhvh",
    "hey come on if u cant win get Elemental",
    "how to win a hvh? step 1 get Elemental"
}
...
local WatermarkConnection = RunService.RenderStepped:Connect(function()
    ...
    Library:SetWatermark(("[ Elemental ] | Private |  %s | %s (%d) | Uptime: %s | FPS %d | %d ms"):format(
